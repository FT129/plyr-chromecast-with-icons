typeof navigator === "object" && (function (global, factory) {
  ...
  const googlecast = {
    ...
    onVolumeChange() {
      const plyr = googlecast.getCurrentPlyr(); // We need to specially handle the case where plyr is muted
    ...
    castStateListener(data) {
      ...
      if (plyr && castEvent) {
        const castActive = castEvent === 'castenabled'; // Add class hook
    ...
    show() {
      ...
      let active = this.storage.googlecast; // Otherwise fall back to the default config
  ...
  class Listeners {
    constructor(_player) {
      ...
      _defineProperty$1(this, "controls", () => {
        ...
        this.bind(elements.buttons.googlecast, 'click', player.googlecast, 'googlecast'); // Fullscreen toggle
  ...
  const source = {
    ...
    change(input) {
      ...
      this.destroy.call(this, () => {
        ...
        this.media = null; // Remove hls property if set
